...
function Footer() {
  return (
    <div>
      <footer className="py-6 md:py-8 text-gray-600 mt-10 border-t-2 border-t-gray-200 bg-gray-200 px-4 rounded-t-3xl">
        <div className="grid gap-8 md:gap-14 grid-cols-5 grid-row-2 container md:max-w-screen-xl mx-auto">
          <div className="col-span-5 md:col-span-2 flex flex-col justify-start">
            <div>
              <h2 className="text-blue-600 font-bold text-xs sm:text-sm mb-4">
              ...
              <div className="sm:leading-7 text-xs sm:text-sm leading-5">
                <span>
                  <strong>فرحان احمدی هستم ، برنامه نویس وب</strong> و مدیر
                ...
                <p className="leading-5 md:leading-7">
                  ...
                  آموزش ها با وسواس خاصی طراحی شده اند به گونه ای که مفاهیم
                  برنامه نویسی را در طی پروژه های متنوع به خوبی درک بکنید. در طی
                  مسیر شما قطعا تنها نخواهید بود، بلکه مربی کار آزموده در
                  کنارتان هست تا خیالتان از بابت مشکلات فنی و مشاوره ای راحت
                  باشد. زمان شما برای ما مهم هست و میخواهیم بدون سعی و خطا در
                  کمترین زمان ممکن به بازار کار برسید. علاوه بر این، پشتیبانی
                  دوره ها مدام العمر است و برای همیشه به سوالات شما پاسخ داده می
                  شود. این یعنی خلق یک تجربه خوب در یک مسیر مشخص به همراه مربی و
                  پشتیبان.
                  <br />
            ...
            <div className="mt-4">
              <ul className="flex flex-wrap justify-between items-center w-full">
                <li className="block">
                  ...
                  >
                    <button
                      className="MuiButtonBase-root MuiIconButton-root MuiIconButton-sizeMedium muirtl-1yxmbwk"
                      tabIndex="0"
                      type="button"
                    >
                      <svg
          ...
          <div className="col-span-5 md:col-span-1">
            <h3 className="text-xl mb-4 text-gray-700 ">بخش های سایت</h3>
            <nav>
          ...
          <div className="col-span-5 md:col-span-1">
            <h3 className="text-xl mb-4 text-gray-700">دوره های آموزشی</h3>
            <nav>
              <ul className="text-sm">
                <li className="list-disc py-2 list-inside">
                  <a
          ...
          <div className="col-span-5 md:col-span-1 flex items-start gap-4"></div>
